...
One of the natural big questions in quantum computing is, for a given computational task such as solving a linear system, whether having access to a quantum computer gives you an *advantage* over using your laptop in the smartest way possible.
The advantage can be with respect to any resource: maybe the quantum computer lets you solve your problem faster, or maybe it allows you to solve a more general class of problems.
